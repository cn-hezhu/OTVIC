...
def test_getitem():
    ...
    self = KittiDataset(data_root, ann_file, split, pts_prefix, pipeline, classes, modality)
    data = self[0]
...
def test_bbox2result_kitti():
    ...
    det_annos = self.bbox2result_kitti(results, classes, submission_prefix=temp_kitti_result_dir)
