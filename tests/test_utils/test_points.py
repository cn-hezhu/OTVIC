...
def test_base_points():
    ...
    assert torch.allclose(
        new_points.tensor, torch.tensor([[1, 2, 3, 4, 5, 6, 7]], dtype=base_points.tensor.dtype)
    )
...
def test_cam_points():
    ...
    assert torch.allclose(
        new_points.tensor, torch.tensor([[1, 2, 3, 4, 5, 6, 7]], dtype=cam_points.tensor.dtype)
    )
...
def test_lidar_points():
    ...
    assert torch.allclose(
        new_points.tensor, torch.tensor([[1, 2, 3, 4, 5, 6, 7]], dtype=lidar_points.tensor.dtype)
    )
...
def test_depth_points():
    ...
    assert torch.allclose(
        new_points.tensor, torch.tensor([[1, 2, 3, 4, 5, 6, 7]], dtype=depth_points.tensor.dtype)
    )
