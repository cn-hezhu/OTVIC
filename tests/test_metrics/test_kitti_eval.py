...
def test_eval_class():
    ...
    gt_anno = dict(
        name=gt_name, truncated=gt_truncated, occluded=gt_occluded, alpha=gt_alpha, bbox=gt_bbox
    )
    ...
    ret_dict = eval_class(
        [gt_anno], [dt_anno], current_classes, difficultys, metric, min_overlaps, True, 1
    )
