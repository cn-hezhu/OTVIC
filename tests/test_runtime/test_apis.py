...
def test_show_result_meshlab():
    ...
    expected_outfile_ply_path = os.path.join(out_dir, file_name, expected_outfile_ply)
    expected_outfile_obj_path = os.path.join(out_dir, file_name, expected_outfile_obj)
