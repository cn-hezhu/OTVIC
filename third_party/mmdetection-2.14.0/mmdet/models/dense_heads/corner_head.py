    ...
    def decode_heatmap(
        ...
        if with_centripetal_shift:
            tl_centripetal_shift = (
                transpose_and_gather_feat(tl_centripetal_shift, tl_inds).view(batch, k, 1, 2).exp()
            )
            br_centripetal_shift = (
                transpose_and_gather_feat(br_centripetal_shift, br_inds).view(batch, 1, k, 2).exp()
            )
