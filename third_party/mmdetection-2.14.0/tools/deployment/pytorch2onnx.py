...
def pytorch2onnx(
    ...
    if verify:
        ...
        # get pytorch output
        pytorch_results = model(img_list, img_metas=img_meta_list, return_loss=False, rescale=True)[
            0
        ]
...
def parse_args():
    ...
    parser.add_argument(
        "--dynamic-export", action="store_true", help="Whether to export onnx with dynamic axis."
    )
