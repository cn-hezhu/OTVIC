...
def main(
    version: str, data_root: str, submission_path: str, config_name: str = "predict_2020_icra.json"
) -> None:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_root", help="Directory storing NuScenes data.", default="/data/sets/nuscenes"
    )
