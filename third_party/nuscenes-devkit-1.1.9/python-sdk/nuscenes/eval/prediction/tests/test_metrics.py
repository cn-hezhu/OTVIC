...
class TestFunctions(unittest.TestCase):
    def setUp(self):
        ...
        self.p_many_batches_and_modes = np.array(
            [[0.2, 0.5, 0.3], [0.5, 0.3, 0.2], [0.2, 0.3, 0.5], [0.3, 0.2, 0.5], [0.3, 0.5, 0.2]]
        )
...
class TestMetrics(unittest.TestCase):
    def test_MinADEK(self):
        ...
        self.assertDictEqual(
            min_ade.serialize(),
            {"name": "MinADEK", "k_to_report": [1, 5, 10], "aggregators": [{"name": "RowMean"}]},
        )
    ...
    def test_MinFDEK(self):
        ...
        self.assertDictEqual(
            min_fde.serialize(),
            {"name": "MinFDEK", "k_to_report": [1, 5, 10], "aggregators": [{"name": "RowMean"}]},
        )
