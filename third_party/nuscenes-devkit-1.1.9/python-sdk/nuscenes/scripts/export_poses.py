...
def export_kml(
    coordinates_per_location: Dict[str, Dict[str, List[Dict[str, float]]]], output_path: str
) -> None:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataroot", type=str, default="/data/sets/nuscenes", help="Path where nuScenes is saved."
    )
