        ...
        if sensor_modality == "lidar":
            ...
            if with_anns:
                for box in boxes:
                    ...
                    box.render(
                        ax, view=view_3d, colors=(color, color, "k"), linewidth=box_linewidth
                    )
            ...
            if with_anns:
                if render_2d:
                    ...
                    for box, name in zip(boxes_2d, names):
                        ...
                        ax.plot(
                            [box[0], box[0]], [box[1], box[3]], color=color, linewidth=box_linewidth
                        )
                        ax.plot(
                            [box[2], box[2]], [box[1], box[3]], color=color, linewidth=box_linewidth
                        )
                        ax.plot(
                            [box[0], box[2]], [box[1], box[1]], color=color, linewidth=box_linewidth
                        )
                        ax.plot(
                            [box[0], box[2]], [box[3], box[3]], color=color, linewidth=box_linewidth
                        )
                else:
                    ...
                    for box in boxes:
                        ...
                        if not box_in_image(
                            box, transforms["p_left"][:3, :3], im.size, vis_level=BoxVisibility.ANY
                        ):
                            continue
