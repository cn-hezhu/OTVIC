...
from mmdet3d.utils import cuda_env_device, model_parallelism_to_device
...
class TransFusionDetector(MVXTwoStageDetector):
    ...
    def forward_train(self, *args, **kwargs):
        if "MODEL_PARALLELISM" in os.environ:
            ...
            args, kwargs = scatter_kwargs(args, kwargs, [cuda_env_device(1)], dim=0)
    ...
    def _forward_train(
        ...
        losses = dict()
        if pts_feats:
            pts_feats, img_feats, gt_labels_3d = model_parallelism_to_device(
                pts_feats, img_feats, gt_labels_3d, cuda_env_device(2)
            )
