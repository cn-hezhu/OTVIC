    ...
    def __init__(
        ...
        **kwargs,
        ...
        cls_head = [
            ...
            build_conv_layer(
                conv_cfg, head_conv, num_cls, kernel_size=3, stride=1, padding=1, bias=bias
            ),
        ]
        ...
        self.task_head = SeparateHead(
            in_channels, heads, head_conv=head_conv, final_kernel=final_kernel, bias=bias
        )
...
class CenterHead(nn.Module):
    ...
    def get_task_detections(
        self, num_class_with_bg, batch_cls_preds, batch_reg_preds, batch_cls_labels, img_metas
    ):
        ...
        for i, (box_preds, cls_preds, cls_labels) in enumerate(
            ...
            if top_scores.shape[0] != 0:
                ...
                boxes_for_nms = xywhr2xyxyr(
                    img_metas[i]["box_type_3d"](box_preds[:, :], self.bbox_coder.code_size).bev
                )
