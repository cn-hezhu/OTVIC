_base_ = [
    "../../_base_/datasets/otvic_lidar.py",
]
...
optimizer = dict(type="AdamW", lr=0.00005, weight_decay=0.01)  # lr 0.0001 for 8gpu * 2sample_per_gpu
...
log_level = "INFO"
load_from = "work_dirs/transfusion_voxel_pretrain/latest.pth"
resume_from = None
workflow = [("train", 1)]
gpu_ids = range(0, 8)
